...
public final class ArtioFIXServer
{
    ...
    public static void main(final String[] args)
    {
        ...
        final String controlChannel = "aeron:udp?endpoint=localhost:10001";

        final String controlRequestChannel = "aeron:udp?endpoint=localhost:10003";
        final String controlResponseChannel = "aeron:udp?endpoint=localhost:10004";

        final EngineConfiguration configuration = new EngineConfiguration()
                .bindTo("localhost", 9999)
                .libraryAeronChannel(aeronChannel);

        final AeronArchive.Context aeronArchiveContext = configuration.aeronArchiveContext();
        aeronArchiveContext.controlRequestChannel(controlRequestChannel);
